...
PAG支持集成音频数据，具体方法参照[<font color=blue>如何在AE中导出音频</font>](https://pag.io/docs/pag-music-mark.html) <br/>
PAG中音频文件编码格式为aac，容器格式为mpeg-4，PAG SDK中暂未处理音画同步的逻辑，如果需要播放音频，需要接入方自行处理
